...
public class Cell extends Button {
    ...
    //helper
    public void update(Cell boardCell) {
        ...
        // Additional visual updates based on the game state can be added here
        // For example, you might want to reset any highlighting or specific colors

        // Ensure the cell is not in a highlighted state
        this.setDefaultColor();
    }
